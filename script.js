...
function showNotification(message, type = 'info') {
    ...
    notification.style.cssText = `
        ...
        max-width: 400px;
        ${type === 'success' ? 'background: #dc2626;' : ''}
        ${type === 'error' ? 'background: #991b1b;' : ''}
        ${type === 'info' ? 'background: #000000;' : ''}
    `;
...
window.addEventListener('scroll', () => {
    ...
    if (techPattern) {
        techPattern.style.transform = `translateY(${scrolled * 0.5}px)`;
    }
});
...
document.querySelectorAll('.project-card').forEach(card => {
    card.addEventListener('mouseenter', function() {
        ...
        this.style.boxShadow = '0 20px 40px rgba(30, 58, 138, 0.2)';
    });
...
function createScrollToTopButton() {
    ...
    scrollBtn.addEventListener('mouseenter', () => {
        ...
        scrollBtn.style.boxShadow = '0 6px 20px rgba(220, 38, 38, 0.4)';
    });
    
    scrollBtn.addEventListener('mouseleave', () => {
        scrollBtn.style.transform = 'translateY(0)';
        scrollBtn.style.boxShadow = '0 4px 15px rgba(220, 38, 38, 0.3)';
    });
}
